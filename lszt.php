	...
	include 'headu.php';
		...
		foreach ($stmt as $v) {
			//$ii++;
				...
				echo '<p style="margin-bottom:0px;"><span style="color:green;">主题：</span><a href="ssdm.php?d=';
				echo $v['dtime'].'&m='.$v['mtime'];
				echo '">'.$v['bt'].'</a></p><p style="margin-bottom:0px;"><span style="color:green;">要求：</span>'.$v['bz'].'</p><p><span style="color:green;">ID:</span>';
				echo $v['id'];

...
<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 309px; text-align: center;">
...
<P style="position: relative;margin-top:10px;"><SPAN class="p_logo"></SPAN>
			...
			<img style="margin-top:10px;cursor: pointer;" id="dsafasdfdas" onclick="this.src='/cachec/yzm.php?a=showseccode&update=' + Math.random()" src="/cachec/yzm.php" width="336px;" height="59px;">
...
<P style="margin: 0px 35px 20px 45px;margin-left: 34px;"><SPAN style="float: left;"><A style="color:#000;" 
href="javascript:;" onclick="wjmm();">忘记密码?</A> <A style="color:#000; margin-left: 10px;" 
href="javascript:;" onclick="zcccsss();">注册</A> </SPAN> 
           <SPAN style="float: right;">
		   
<A style="color: green; margin-right: 10px;" 
href="/Connect/example/oauth/index.php"><img style="vertical-align: middle;height: 16px;margin-top: -2px;margin-right: 5px;" src="qq_24px_1164430_easyicon.net.png">QQ登录</A>
		   
		   
              

<input type="button" style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  value="登录" onclick="ajaxpost();" />
...
<?php
	if(!$conf['re']){
		echo 'layer.alert(\'网站已经关闭注册功能，请联系管理员。\',{title:\'提示\'})';
	}else{

...
class="u_logo"></SPAN>         <INPUT class="ipt" type="text" name="yhm" placeholder="请输入用户名" value=""> 
    </P>
...
<P style="position: relative;margin-top:10px;"><SPAN class="p_logo"></SPAN>
			<input autocomplete="off" class="ipt" autocomplete="off" type="text" name="code" placeholder="请输入验证码" value="" / >
			

			<img style="margin-top:10px;cursor: pointer;" onclick="this.src='/cachec/yzm.php?a=showseccode&update=' + Math.random()" src="/cachec/yzm.php" width="336px;" height="39px;">
...
<input type="submit" style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  value="登录绑定QQ号" />
